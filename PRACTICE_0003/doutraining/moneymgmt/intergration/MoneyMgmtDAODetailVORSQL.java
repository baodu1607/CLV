...
*@FileName : MoneyMgmtDAODetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MoneyMgmtDAODetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MoneyMgmtDAODetailVORSQL(){
		setQuery();
		...
		query.append("FileName : MoneyMgmtDAODetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
