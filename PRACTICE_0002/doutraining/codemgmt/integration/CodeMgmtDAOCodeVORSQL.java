...
*@FileName : CodeMgmtDAOCodeVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDAOCodeVORSQL implements ISQLTemplate{
	...
	public CodeMgmtDAOCodeVORSQL(){
		...
		query.append("FileName : CodeMgmtDAOCodeVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
