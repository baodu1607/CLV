...
<%@ page import="com.clt.apps.opus.esm.clv.doutraining.errmsgmgmt.event.Practice0001Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	Practice0001Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (Practice0001Event)request.getAttribute("Event");
